...
function ClientSocket.Receive(var buffer: Array of Byte;
  expectedByteCount: Integer): Integer;
var
  byteCount: Integer;
  readCount: Integer;
begin
  ...
  while byteCount < expectedByteCount do begin
    readCount := Recv(self.s, buffer[byteCount], expectedByteCount - byteCount, 0);
    if readCount < 0 then
      break;
